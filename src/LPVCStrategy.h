...
#ifndef LPVCSTRATEGY_H_
#define LPVCSTRATEGY_H_
...
class LPVCStrategy : public virtual VertexCoverStrategy{
	Graph *g;
public:
	LPVCStrategy(Graph &g) : g(&g){}
	...
	virtual ~LPVCStrategy(){};
};

#endif /* LPVCSTRATEGY_H_ */
